...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-im': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/browser/browser-runtime-deterministic': { kind: 'indirect', reason: 'The Provider delegates all deterministic Browser Runtime rendering to dsh-tool-browser.' },
  'packages/browser/browser-runtime-electron': { kind: 'indirect', reason: 'The Provider delegates page, screenshot, lifecycle, and availability rendering to dsh-tool-browser.' },
  'packages/browser/browser-runtime-tandem': { kind: 'indirect', reason: 'The Provider delegates page, screenshot, lifecycle, and availability rendering to dsh-tool-browser.' },
  'packages/browser/browser-runtime': { kind: 'indirect', reason: 'The Service Definition delegates Browser Runtime result rendering to dsh-tool-browser.' },
  'packages/browser/browser-workspace': { kind: 'indirect', reason: 'The Binder delegates Workspace rendering to dsh-tool-browser and contributes no request text itself.' },
  'packages/client/ui-browser': { kind: 'indirect', reason: 'Browser-side operations mutate Browser Workspace state that dsh-tool-browser later renders.' },
  'packages/client/ui-desktop': { kind: 'indirect', reason: 'Desktop controls change Account and Personal Pairing state used to admit mobile-origin work into Host Sessions.' },
  'packages/client/ui-member-questions': { kind: 'indirect', reason: 'The browser card settles human answers into the shared ask-user tool result.' },
  'packages/client/ui-workbench': { kind: 'indirect', reason: 'Workbench operations mutate Browser Workspace state that dsh-tool-browser later renders.' },
  'packages/code-runtime/code-runtime-python': { kind: 'none', reason: 'Protocol-only package; validates and exports fd-3 frames without executing code or rendering model-facing results.' },
  'packages/interaction/member-question-receiver': { kind: 'indirect', reason: 'The receiver materializes bounded Decision Brief context and admits later human turns into Host Sessions.' },
  'packages/interaction/member-question-sender': { kind: 'indirect', reason: 'The sender delegates member routing and retained results to dsh-tool-ask-user.' },
  'packages/platform/noise-channel': { kind: 'none', reason: 'Pure transport; carries pairing capabilities and ciphertext without creating model-bound content.' },
  'packages/platform/platform-account-client': { kind: 'indirect', reason: 'The client supplies authenticated Account and installation state used by Project Membership and Personal Pairing model-facing flows.' },
  'packages/platform/platform-account-core': { kind: 'indirect', reason: 'The Provider supplies identity and installation authorization to membership, pairing, and receiving flows that reach model-facing consumers.' },
  'packages/platform/platform-account-http': { kind: 'indirect', reason: 'The HTTP routes establish Account Sessions used by Project Membership and Personal Pairing model-facing flows.' },
  'packages/platform/platform-account': { kind: 'indirect', reason: 'The Account seam supplies authenticated identity and installation state to downstream model-facing membership, pairing, and receiving flows.' },
  'packages/platform/project-membership-client': { kind: 'indirect', reason: 'Client mutations change membership data later rendered by project_members and member-question routing.' },
  'packages/platform/project-membership-core': { kind: 'indirect', reason: 'The Provider owns roster, role, and tag data rendered by project_members and member-question consumers.' },
  'packages/platform/project-membership-desktop': { kind: 'indirect', reason: 'The Provider delegates roster and member-origin rendering to dsh-tool-project-members and dsh-tool-ask-user.' },
  'packages/platform/project-membership-http': { kind: 'indirect', reason: 'The HTTP routes mutate Project Membership data later rendered by model-facing membership consumers.' },
  'packages/platform/project-membership': { kind: 'indirect', reason: 'The membership seam supplies roster, role, tag, invitation, and presence data to project_members and member-question consumers.' },
  'packages/platform/remote-access-client': { kind: 'none', reason: 'Pure transport; carries authenticated Companion operations and routes without creating model-bound content.' },
  'packages/platform/remote-access-http': { kind: 'none', reason: 'Pure transport; HTTP and WSS consumers carry pairing authority, routes, and ciphertext without creating model-bound content.' },
  'packages/platform/remote-access-redis': { kind: 'none', reason: 'Pure transport; the Redis Provider carries Relay routes and ciphertext without creating model-bound content.' },
  'packages/platform/remote-access': { kind: 'none', reason: 'Pure transport and authority; carries pairing authority and delivery routes without creating model-bound content.' },
  'packages/platform/remote-attachments': { kind: 'none', reason: 'Pure transport; carries encrypted blobs and consume capabilities without creating model-bound content.' },
  'packages/platform/remote-protocol': { kind: 'none', reason: 'Pure transport codecs; carry already-produced Companion operation content without creating model-bound content or choosing its presentation.' },
