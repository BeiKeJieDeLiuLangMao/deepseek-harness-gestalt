...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-member-questions': { kind: 'none', reason: 'Browser-side selector-routed composer card over the shared ask-user presentation; registers no prompt, schema, or tool.' },
