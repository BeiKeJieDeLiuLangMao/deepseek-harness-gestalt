...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-browser': { kind: 'none', reason: 'Browser-side chrome; registers no prompt, schema, message, tool, or provider request.' },
  'packages/client/ui-desktop': { kind: 'none', reason: 'Browser-side Desktop chrome; registers nothing model-facing.' },
  'packages/client/ui-member-questions': { kind: 'none', reason: 'Browser-side question presentation; the shared ask-user surface owns the model-facing content.' },
  'packages/client/ui-workbench': { kind: 'none', reason: 'Browser-side Workspace presentation; registers no prompt, schema, stream, or tool.' },
  ...
  'packages/interaction/member-question-receiver': { kind: 'none', reason: 'Arrival, projection, settlement, and reservation state stay outside model requests; the Host admission adapter owns any later human turn.' },
  ...
  'packages/platform/noise-channel': { kind: 'none', reason: 'Pairing, Relay authority, and Companion transport metadata never enter model requests.' },
  'packages/platform/platform-account-client': { kind: 'none', reason: 'Client-side Platform Account control contributes no model-visible state.' },
  'packages/platform/platform-account-core': { kind: 'none', reason: 'Platform Account authorization stays outside agent sessions and model requests.' },
  'packages/platform/platform-account-http': { kind: 'none', reason: 'HTTP routes serve installation UI and register nothing model-facing.' },
  'packages/platform/platform-account': { kind: 'none', reason: 'Platform Account state adds no messages, tools, or prompt text.' },
  'packages/platform/project-membership-client': { kind: 'none', reason: 'Client-side Project Membership transport contributes no model-visible state.' },
  'packages/platform/project-membership-core': { kind: 'none', reason: 'Project Membership authority stays outside agent sessions and model requests.' },
  ...
  'packages/platform/project-membership-http': { kind: 'none', reason: 'HTTP routes serve installation UI and product clients and register nothing model-facing.' },
  'packages/platform/project-membership': { kind: 'none', reason: 'Project Membership authority stays outside agent sessions and model requests.' },
  'packages/platform/remote-access-client': { kind: 'none', reason: 'Client-side Remote Access transport values never enter model requests.' },
  'packages/platform/remote-access-http': { kind: 'none', reason: 'The HTTP Consumer handles pairing state outside model requests.' },
  'packages/platform/remote-access-redis': { kind: 'none', reason: 'Redis Relay coordination never enters model requests.' },
  'packages/platform/remote-access': { kind: 'none', reason: 'Pairing metadata, Device Principal origin, and Settings state never enter model requests.' },
  'packages/platform/remote-attachments': { kind: 'none', reason: 'Attachment ciphertext and capabilities never enter model requests.' },
  'packages/platform/remote-protocol': { kind: 'none', reason: 'Remote Protocol metadata and device origin never enter model requests.' },
