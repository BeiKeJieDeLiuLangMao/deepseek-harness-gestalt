...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/code-runtime/code-runtime-python': { kind: 'indirect', reason: 'The Python backend delegates result and log-marker rendering to PTC mode in dsh-tools.' },
  ...
  'packages/platform/noise-channel': { kind: 'indirect', reason: 'The channel authenticates Companion operations that downstream consumers turn into member questions, references, and Session work.' },
  ...
  'packages/platform/remote-access-client': { kind: 'indirect', reason: 'The client transports authenticated Companion operations that Host consumers turn into model-facing work.' },
  'packages/platform/remote-access-http': { kind: 'indirect', reason: 'The HTTP and WSS routes deliver authenticated Companion operations to Host model-facing consumers.' },
  'packages/platform/remote-access-redis': { kind: 'indirect', reason: 'The Redis Provider coordinates Relay delivery for Companion operations consumed by model-facing Host flows.' },
  'packages/platform/remote-access': { kind: 'indirect', reason: 'The services authorize and deliver paired Mobile operations into member-question and Session consumers.' },
  'packages/platform/remote-attachments': { kind: 'indirect', reason: 'The store delivers decrypted reference files and images that the member-question receiver materializes for model-facing Session work.' },
  'packages/platform/remote-protocol': { kind: 'indirect', reason: 'The codecs carry origin, background, questions, answers, and references into member-question tools and receiving Sessions.' },
