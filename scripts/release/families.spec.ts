...
describe('release families', () => {
  it('excludes private experimental packages and product apps from the dsh release', () => {
    ...
    expect(directories).not.toEqual(expect.arrayContaining(['apps/desktop', 'apps/mobile', 'apps/platform']))
  })
