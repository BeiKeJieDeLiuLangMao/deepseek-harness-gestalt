...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  subagentRoutePreauthorization: 'subagent.md',
  webhookRuntime: 'web.md',
  ...
  desktopProjectMembership: 'project-membership.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  appReady: 'not a service: launcher-provided boot-ready signal — packages/boot/cmdline/README.md owns the launcher contract',
  ...
  sidebarRight: 'client-side official right Sidebar service — packages/client/ui-sidebar-right/README.md owns the API',
  sidebarRightTabs: 'client-side official right Sidebar tab registry — packages/client/ui-sidebar-right/README.md owns the API',
  sidebarRightPreferences: 'client-side official right Sidebar preferences — packages/client/ui-sidebar-right/README.md owns the API',
  uiConversation: 'client-side conversation chrome — packages/client/ui-conversation/README.md owns the API',
  uiSession: 'client-side session chrome — packages/client/ui-session/README.md owns the API',
  uiWorkspace: 'client-side workspace chrome — packages/client/ui-workspace/README.md owns the API',
  projectMembershipClient: 'client-side project-membership accessor — packages/platform/project-membership-client/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'goal': 'goal.md',
  'llm': 'llm-streaming.md',
  'member-question-receiver': 'user-questions.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  IosEnvironmentProvider: 'phone-runtime.md',
  ...
  BrowserProfileChrome: 'browser-runtime.md',
  BrowserProfileId: 'browser-runtime.md',
  BrowserProfileKind: 'browser-runtime.md',
  BrowserProfileName: 'browser-runtime.md',
  BrowserProfileStorage: 'browser-runtime.md',
  ...
  AccountDeletionRecovery: 'platform-account.md',
  AccountDeletionView: 'platform-account.md',
  AccountDeletionRequest: 'platform-account.md',
  AccountDeletionSuccessor: 'platform-account.md',
  ...
  PlatformAccountView: 'platform-account.md',
  PublicAccountIdentity: 'platform-account.md',
  MobileAccessState: 'personal-pairing.md',
  MobilePairingStatus: 'personal-pairing.md',
  PairingAccountAuthentication: 'personal-pairing.md',
  PairingChallengeId: 'personal-pairing.md',
  PairingChallengeView: 'personal-pairing.md',
  PairingCompletionId: 'personal-pairing.md',
  PairingCompletionView: 'personal-pairing.md',
  PairingDeviceDescription: 'personal-pairing.md',
  EndpointPairingChallengeView: 'personal-pairing.md',
  EndpointPairingConfirmation: 'personal-pairing.md',
  EndpointPairingDesktopView: 'personal-pairing.md',
  EndpointPairingMobileView: 'personal-pairing.md',
  ...
  RelayPeerUpdateMessage: 'personal-pairing.md',
  RelayReadyMessage: 'personal-pairing.md',
  RelayRouteId: 'personal-pairing.md',
  RemoteRelayAttachment: 'personal-pairing.md',
  ProjectPeerGrantView: 'personal-pairing.md',
  ProjectPeerProjectId: 'personal-pairing.md',
  SealedProjectPeerGrant: 'personal-pairing.md',
  ...
  ScheduleId: 'schedule.md',
  ScheduleView: 'schedule.md',
  ...
  MemberQuestionSendPayload: 'user-questions.md',
  ...
  MemberQuestionReceiverChange: 'user-questions.md',
  AuthenticatedMemberQuestionEnvelope: 'user-questions.md',
  MemberQuestionIngestResult: 'user-questions.md',
  ...
  AcceptInvitationInput: 'project-membership.md',
  ChangeRoleInput: 'project-membership.md',
  CreateProjectInput: 'project-membership.md',
  DesktopMemberPresentation: 'project-membership.md',
  DesktopMemberQuestionOrigin: 'project-membership.md',
  DesktopMemberQuestionRoute: 'project-membership.md',
  DesktopProjectMembershipContext: 'project-membership.md',
  FunctionTag: 'project-membership.md',
  ...
  PlatformAccountId: 'platform-account.md',
  ...
  AgentPresetRoster: 'core.md',
  AgentPresetComposition: 'core.md',
  AgentPresetDocument: 'core.md',
  AgentPresetDirectoryOpenValue: 'core.md',
  ...
  SessionToolEligibility: 'session.md',
  SessionToolEligibilityRequest: 'session.md',
  ...
  SessionAdmitAttachmentRequest: 'session.md',
  SessionAdmitAttachmentValue: 'session.md',
  ...
  SettingsWebSearchProbeValue: 'settings.md',
  ...
  WorkspaceGitRemoteRequest: 'workspace.md',
  WorkspaceGitRemoteValue: 'workspace.md',
  WorkspaceCloneGitRequest: 'workspace.md',
  WorkspaceCloneGitValue: 'workspace.md',
  WorkspaceFollowFrame: 'workspace.md',
  WorkspaceFileRange: 'workspace.md',
  WorkspaceFileText: 'workspace.md',
  WorkspaceByteRange: 'workspace.md',
  WorkspaceFileStat: 'workspace.md',
  WorkspaceDirectoryListing: 'workspace.md',
  WorkspaceFileWatchFrame: 'workspace.md',
  WorkspaceFileScope: 'workspace.md',
  WorkspaceFileBytes: 'workspace.md',
  ...
  SaveByteAttachment: 'attachment.md',
  StoredByteAttachment: 'attachment.md',
  SaveFileStreamAttachment: 'attachment.md',
  ByteAttachmentRef: 'attachment.md',
  ...
  MemberQuestionRemoteSettleRequest: 'user-questions.md',
  MemberQuestionRemoteSettleResponse: 'user-questions.md',
  MemberQuestionRemoteAdmitHumanTurnRequest: 'user-questions.md',
  MemberQuestionRemoteAdmitHumanTurnResponse: 'user-questions.md',
  ...
  SessionLogOffset: 'session-query.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PersonalPairingId: 'personal pairing identity is owned by packages/platform/remote-access/README.md',
  ...
  MemberQuestionId: 'branded Companion question identity is owned by packages/platform/remote-protocol/src/types.ts',
  ...
  InspectorJsonValue: 'experimental inspector payload is owned by packages/experimental/inspector/README.md',
  WebhookRule: 'webhook rule contract is owned by packages/webhook/webhook/README.md',
  VerifiedWebhookDelivery: 'webhook delivery contract is owned by packages/webhook/webhook/README.md',
}
