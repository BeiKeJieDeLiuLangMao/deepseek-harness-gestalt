...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CompanionPushHint: 'remote-protocol.md',
  CompanionPushToken: 'remote-protocol.md',
  CompanionPushReport: 'personal-pairing.md',
  PushTokenRegistration: 'personal-pairing.md',
