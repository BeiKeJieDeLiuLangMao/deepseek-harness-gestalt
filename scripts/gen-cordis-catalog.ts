...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  receivingQuestions: 'client-side member-question projection book — packages/api/session-controller/README.md owns the API',
  ...
  browserUi: 'client-side Browser UI behavior for the snapshot renderer adapter — packages/client/ui-browser/README.md owns the API',
  workbenchBrowser: 'client-side official Browser tab face — packages/client/ui-workbench/README.md owns the API',
  projectMembershipClient: 'client-side Project Membership HTTP service — packages/platform/project-membership-client/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CompanionMemberQuestionSettledResult: 'user-questions.md',
  MemberQuestionHumanTurnAdmitter: 'user-questions.md',
  MemberQuestionId: 'user-questions.md',
  ...
  DingTalkSendMessageRequest: 'im.md',
  DingTalkSendMessageResult: 'im.md',
  DingTalkSendStatusResult: 'im.md',
  ImAccountId: 'im.md',
  ImAccountMetadata: 'im.md',
  ...
  ImGuiInjectManagedHumanMessageOptions: 'im.md',
  ImGuiHistoryQueryOptions: 'im.md',
  ImGuiInboundView: 'im.md',
  ImGuiListOutboundOptions: 'im.md',
  ImGuiOutboundView: 'im.md',
  ImGuiRegisterManualOutboundOptions: 'im.md',
  ImHistoryQueryOptions: 'im.md',
  ImMessageId: 'im.md',
  ImOutboundRequestId: 'im.md',
  ImResolveRouteRequest: 'im.md',
  ImResolveRouteResult: 'im.md',
  ImRouteRule: 'im.md',
  ImRouteRuleId: 'im.md',
  ImScopeId: 'im.md',
  ImSimulationInstance: 'im.md',
  ImSimulationInstanceId: 'im.md',
  ImWorkspaceSimulationConfig: 'im.md',
  ImportJsonlHistoryOptions: 'im.md',
  InboundMessageRecord: 'im.md',
  InjectManagedHumanMessageOptions: 'im.md',
  InjectMemberMessageOptions: 'im.md',
  ListImOutboundOptions: 'im.md',
  MarkSubmittedOptions: 'im.md',
  OutboundMessageRecord: 'im.md',
  ReceiveInboundOptions: 'im.md',
  ReceiveInboundResult: 'im.md',
  RegisterOutboundOptions: 'im.md',
  ResolvedWangwangCredentials: 'im.md',
  SetWorkspaceSimulationTargetOptions: 'im.md',
  SettleOutboundOptions: 'im.md',
  WangwangAdmittedMerchant: 'im.md',
  WangwangRawEvent: 'im.md',
  WangwangSendMessageRequest: 'im.md',
  WangwangSendMessageResult: 'im.md',
  WangwangSenderResolution: 'im.md',
}
