...
来源：[`packages/api/gateway/src/index.ts:137`](../packages/api/gateway/src/index.ts)
...
来源：[`packages/api/session-controller/src/index.ts:82`](../packages/api/session-controller/src/index.ts)
...
依赖：[`NativeCommandRunner`](../packages/util/native-command/src/index.ts)

来源：[`packages/api/workspace-controller/src/index.ts:38`](../packages/api/workspace-controller/src/index.ts)
...
来源：[`packages/attachment/attachment-local/src/index.ts:72`](../packages/attachment/attachment-local/src/index.ts)
...
来源：[`packages/client/ui-better-sidebar/src/config.ts:38`](../packages/client/ui-better-sidebar/src/config.ts)
...
需要：`subprocess` · `imConfig` · `imDelivery`
...
来源：[`packages/im/im-dingtalk/src/types.ts:10`](../packages/im/im-dingtalk/src/types.ts)

<a id="deepseek-aidsh-im-wangwang"></a>

## `@deepseek-ai/dsh-im-wangwang`

需要：`credentials` · `storageDomain` · `imDelivery`
...
依赖：[`CredentialRef`](subsystems/credentials.zh.md) · [`ImAccountId`](subsystems/im.zh.md)

来源：[`packages/im/im-wangwang/src/types.ts:33`](../packages/im/im-wangwang/src/types.ts)
...
依赖：[`Branded`](subsystems/core.zh.md) · [`CompanionMemberQuestionOperation`](../packages/platform/remote-protocol/src/index.ts) · [`CompanionMemberQuestionSettledResult`](subsystems/user-questions.zh.md) · [`HostSessionId`](subsystems/core.zh.md) · [`ImageAttachmentRef`](subsystems/attachment.zh.md) · [`MemberQuestionId`](subsystems/user-questions.zh.md) · [`PlatformAccountId`](subsystems/platform-account.zh.md) · [`ProjectId`](subsystems/project-membership.zh.md)

来源：[`packages/interaction/member-question-receiver/src/index.ts:152`](../packages/interaction/member-question-receiver/src/index.ts)
...
依赖：[`CompanionMemberQuestionSettledResult`](subsystems/user-questions.zh.md) · [`CompanionMessage`](../packages/platform/remote-protocol/src/index.ts) · [`CompanionOperationId`](../packages/platform/remote-protocol/src/index.ts) · [`DocumentTransferId`](../packages/platform/remote-protocol/src/index.ts) · [`MemberQuestionId`](subsystems/user-questions.zh.md) · [`ProjectId`](subsystems/project-membership.zh.md) · [`SealedProjectPeerGrant`](subsystems/personal-pairing.zh.md)

来源：[`packages/interaction/member-question-sender/src/index.ts:181`](../packages/interaction/member-question-sender/src/index.ts)
...
来源：[`packages/phone/phone-environment/src/index.ts:83`](../packages/phone/phone-environment/src/index.ts)
...
来源：[`packages/phone/phone-stream/src/index.ts:66`](../packages/phone/phone-stream/src/index.ts)
...
来源：[`packages/platform/platform-account-http/src/index.ts:32`](../packages/platform/platform-account-http/src/index.ts)
...
来源：[`packages/platform/project-membership-desktop/src/index.ts:64`](../packages/platform/project-membership-desktop/src/index.ts)
...
来源：[`packages/platform/project-membership-http/src/index.ts:57`](../packages/platform/project-membership-http/src/index.ts)
...
来源：[`packages/platform/remote-access-http/src/index.ts:31`](../packages/platform/remote-access-http/src/index.ts)
...
<a id="deepseek-aidsh-subagent-route-preauthorization-static"></a>
...
依赖：[`SubagentRoute`](subsystems/subagent.zh.md)

来源：[`packages/subagent/subagent-route-preauthorization-static/src/index.ts:11`](../packages/subagent/subagent-route-preauthorization-static/src/index.ts)
...
依赖：[`Agent`](subsystems/core.zh.md) · [`AskUserQuestionMemberOrigin`](../packages/interaction/user-questions/src/index.ts) · [`PlatformAccountId`](subsystems/platform-account.zh.md) · [`ProjectId`](subsystems/project-membership.zh.md)

来源：[`packages/interaction/tool-ask-user/src/index.ts:89`](../packages/interaction/tool-ask-user/src/index.ts)
...
依赖：[`Agent`](subsystems/core.zh.md) · [`Branded`](subsystems/core.zh.md) · [`RosterView`](subsystems/project-membership.zh.md)

来源：[`packages/interaction/tool-project-members/src/index.ts:124`](../packages/interaction/tool-project-members/src/index.ts)
...
export interface Config {
  ...
  /** Enable the reserved `tool_search` discovery tool; `false` disables deferred registrations. */
  toolSearch?: false | {
    /** Results returned when the model omits `limit` (default 5). */
    defaultLimit?: number
    /** Highest accepted `limit` (default 10). */
    maxResults?: number
    /** Maximum UTF-8 bytes in a complete fresh or reconstructed durable discovery result. */
    maxResultBytes: number
  }
}
...
来源：[`packages/core/tools/src/index.ts:801`](../packages/core/tools/src/index.ts)
...
- `@deepseek-ai/dsh-browser-workspace` — 需要 `browserRuntime` · `sessions` ([`packages/browser/browser-workspace/src/index.ts`](../packages/browser/browser-workspace/src/index.ts))
...
- `@deepseek-ai/dsh-im-core` — 需要 `storageDomain` ([`packages/im/im-core/src/index.ts`](../packages/im/im-core/src/index.ts))
...
抽象服务类——部署应改为加载具体实现包（参见[能力 seam](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。
...
- `@deepseek-ai/dsh-subagent-route-preauthorization` — abstract `SubagentRoutePreauthorization` ([`packages/subagent/subagent-route-preauthorization/src/index.ts`](../packages/subagent/subagent-route-preauthorization/src/index.ts))
