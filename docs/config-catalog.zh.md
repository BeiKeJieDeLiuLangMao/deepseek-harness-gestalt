...
Source: [`packages/api/gateway/src/index.ts:137`](../packages/api/gateway/src/index.ts)
...
Source: [`packages/api/settings-controller/src/index.ts:48`](../packages/api/settings-controller/src/index.ts)
...
来源：[`packages/attachment/attachment-local/src/index.ts:66`](../packages/attachment/attachment-local/src/index.ts)
...
来源：[`packages/goal/goal/src/index.ts:156`](../packages/goal/goal/src/index.ts)
...
来源：[`packages/test-support/llm-replay/src/index.ts:870`](../packages/test-support/llm-replay/src/index.ts)
...
Depends on: [`SubagentRoute`](subsystems/subagent.zh.md)
...
来源：[`packages/interaction/tool-project-members/src/index.ts:122`](../packages/interaction/tool-project-members/src/index.ts)
...
来源：[`packages/shell/tool-pwsh-persistent/src/index.ts:488`](../packages/shell/tool-pwsh-persistent/src/index.ts)
...
抽象服务类 — 部署加载具体实现包，而不是这些包本身（[能力缝合](../.agents/notes/implemented/architecture/2026-06-13-capability-seams.zh.md)）。
