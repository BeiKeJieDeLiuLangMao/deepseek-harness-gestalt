...
来源：[`packages/llm/llm-gestalt-account-pool/src/index.ts:14`](../packages/llm/llm-gestalt-account-pool/src/index.ts)
...
来源：[`packages/platform/platform-account-http/src/index.ts:35`](../packages/platform/platform-account-http/src/index.ts)
...
依赖：[`Agent`](subsystems/core.zh.md) · [`Branded`](../packages/util/brand/src/index.ts) · [`RosterView`](subsystems/project-membership.zh.md)
...
- `@deepseek-ai/dsh-browser-runtime` — 抽象 `BrowserRuntime`（[`packages/browser/browser-runtime/src/index.ts`](../packages/browser/browser-runtime/src/index.ts))
...
- `@deepseek-ai/dsh-project-membership` — 抽象 `ProjectMembershipService`（[`packages/platform/project-membership/src/index.ts`](../packages/platform/project-membership/src/index.ts))
...
- `@deepseek-ai/dsh-subagent-route-preauthorization` — 抽象 `SubagentRoutePreauthorization`（[`packages/subagent/subagent-route-preauthorization/src/index.ts`](../packages/subagent/subagent-route-preauthorization/src/index.ts))
...
- `@deepseek-ai/dsh-cliproxy-quota`（[`packages/llm/cliproxy-quota/src/index.ts`](../packages/llm/cliproxy-quota/src/index.ts))
