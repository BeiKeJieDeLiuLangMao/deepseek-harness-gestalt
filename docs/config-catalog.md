...
Source: [`packages/attachment/attachment-local/src/index.ts:72`](../packages/attachment/attachment-local/src/index.ts)
...
Source: [`packages/platform/project-membership-http/src/index.ts:57`](../packages/platform/project-membership-http/src/index.ts)
...
Requires: `remoteAccess` · `webServer`
...
Source: [`packages/platform/remote-access-http/src/index.ts:31`](../packages/platform/remote-access-http/src/index.ts)
...
Source: [`packages/browser/tool-browser/src/index.ts:28`](../packages/browser/tool-browser/src/index.ts)
...
- `@deepseek-ai/dsh-client-ui-workbench` — requires `settings` ([`packages/client/ui-workbench/src/index.ts`](../packages/client/ui-workbench/src/index.ts))
