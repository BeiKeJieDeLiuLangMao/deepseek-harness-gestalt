...
| `ctx.remoteAccess` | `seam` | [`remote-access`](../packages/platform/remote-access) | [`remote-access`](../packages/platform/remote-access) | - | - | 在同一包中组合公开 lifecycle definition 与单进程 provider；Desktop 与 Mobile 在组装经过独立评审的 handshake adapter 前保持 fail-closed。 |
