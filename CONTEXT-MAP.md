...
| DeepSeek Gestalt | [apps/desktop/CONTEXT.md](apps/desktop/CONTEXT.md) | Desktop Host, Desktop Bundle, Window Chrome, Update Control, Personal Release Channel, Launch Directory, built-in account pool, CLIProxyAPI core, and Desktop-specific Session Surface projection |
