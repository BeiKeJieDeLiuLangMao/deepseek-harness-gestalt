...
const EXPECTED_PAGE_CI_MS = 1000
...
it('accepts recorded hosted paging and Trajectory medians and rejects slower endpoints', () => {
  const hostedPageMedian = 958.2968290000026
  expect(() => expectEndpointWithinBudget(hostedPageMedian, 875)).toThrow()
  expectEndpointWithinBudget(hostedPageMedian, PAGE_BUDGET_MS)
  const endpoints = [
    { samples: [843.941625, 672.834329, 684.461818], reference: REFERENCE.page, budget: PAGE_BUDGET_MS, expectedBudget: 1250 },
