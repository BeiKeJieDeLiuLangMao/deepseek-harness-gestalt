...
// Coverage CI requires pwsh without a repeat process probe; other hosts follow
// the executor's resolution, including Program Files installs on Windows.
const hasPwsh = testPwshAvailable()
