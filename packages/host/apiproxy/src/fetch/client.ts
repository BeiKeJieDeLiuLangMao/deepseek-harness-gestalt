...
import {
  ...
  sessionAdmitAttachmentValueSchema,
  ...
  sessionToolEligibilityValueSchema,
...
export interface IApiClient {
  ...
  sessions: {
    ...
    toolEligibility(payload: RequestPayload<'session.toolEligibility'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.toolEligibility'>>>
    ...
    admitAttachment(payload: RequestPayload<'session.admitAttachment'>, signal?: AbortSignal): Promise<RpcResponse<ResponseValue<'session.admitAttachment'>>>
...
const UNARY_VALUE_SCHEMAS: { [K in keyof RpcMethodMap]: z.ZodType<Wire<ResponseValue<K>>> } = {
  ...
  'session.toolEligibility': sessionToolEligibilityValueSchema,
  'session.selectModel': sessionSelectModelValueSchema,
  'session.rename': sessionRenameValueSchema,
  'session.fork': sessionForkValueSchema,
  'session.prompt': sessionPromptValueSchema,
  'session.attachment': sessionAttachmentValueSchema,
  'session.admitAttachment': sessionAdmitAttachmentValueSchema,
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    toolEligibility: (payload, signal) => this.callUnary('session.toolEligibility', payload, signal),
    ...
    admitAttachment: (payload, signal) => this.callUnary('session.admitAttachment', payload, signal),
