...
export const RELEASED_V0_EVENT_DISPOSITIONS: Readonly<Record<string, ReleasedV0PayloadDisposition>> = Object.freeze({
  ...
  'browser/workspace': disposition(['workspaces', 'activeWorkspaceId']),
  'member-question/asked': disposition(['questionId', 'toProjectMember', 'projectId', 'background', 'questions', 'originSessionId']),
  'member-question/outcome': disposition(['questionId', 'outcome'], ['answers']),
  'member-question/received': disposition(['questionId', 'projectId', 'originSessionId', 'arrivedAt', 'expiresAt', 'origin', 'background', 'questions', 'references'], ['cachedReferences']),
  'member-question/settled': disposition(['type', 'operationId', 'questionId', 'settledAt', 'outcome'], ['settledByInstallationId', 'settledByDeviceName', 'answers']),
  'session/attachment-admitted': disposition(['attachment', 'operationId', 'source']),
