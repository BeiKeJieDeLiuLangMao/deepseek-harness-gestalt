...
const validPayloads: Readonly<Record<string, SessionFormatJsonValue>> = {
  ...
  'browser/workspace': { workspaces: [], activeWorkspaceId: null },
  'member-question/asked': { questionId: 'q', toProjectMember: 'm', projectId: 'p', background: '', questions: [], originSessionId: 's' },
  'member-question/outcome': { questionId: 'q', outcome: 'offline' },
  'member-question/received': { questionId: 'q', projectId: 'p', originSessionId: 's', arrivedAt: 1, expiresAt: 2, origin: { projectName: '', originSessionTitle: '', askerAccountId: 'a', askerRole: 'member', askerDisplayName: '', askerAvatarUrl: '' }, background: '', questions: [], references: [] },
  'member-question/settled': { type: 'member-question-settled', operationId: 'op', questionId: 'q', settledAt: 2, outcome: 'expired' },
  'session/attachment-admitted': { attachment: { attachmentId: 'a', mediaType: 'text/plain', bytes: 0, sha256: 'a'.repeat(64) }, operationId: 'op', source: 'companion' },
