...
export class EndpointOwnedPairingMailbox {
  ...
  readMobile(
    ...
    | { stage: 'message2'; pendingPairingId: PendingPairingId; message2: Uint8Array }
    ...
    if (record.message2 !== undefined) return {
      stage: 'message2', pendingPairingId: record.pendingPairingId, message2: record.message2.slice(),
    }
