...
Authenticate Platform installations through five-minute GitHub OAuth attempts, S256 PKCE, signed polling tokens, and P-256 proofs. The service retains only public GitHub identity fields, discards provider tokens, and enforces live-installation and connection quotas transactionally. Sessions rotate, revoke, and expire through provider-owned state; failures preserve stable Account codes.
