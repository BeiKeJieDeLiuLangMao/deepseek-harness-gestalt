...
| Session catalog | 256 rows |
| Session search | 20 rows |
| Search query | 500 UTF-16 code units |
...
- The current Companion catalog proves Session creation, prompt submission and cancellation, Host Session search, attachment offers, approval and Ask User settlement, operation-status query, transcript projection including image and interaction cards, and the confirmed, rejected, attachment-rejected, and status result kinds. Discovery of remote Workspaces still belongs to a later catalog slice.
