...
The public types brand Account, Login Attempt, and Account Session ids. `AccountError` exposes stable failure codes for invalid or expired attempts, invalid or replayed proof, and expired or revoked sessions.
