...
export const zh = {
  ...
  'dock.address': '地址',
  'dock.openExternal': '在默认浏览器打开',
  'dock.sharedProfile': '共享身份',
  'dock.closeTab': '关闭标签页',
  'dock.empty': '没有打开的页面',
  'dock.start': '输入地址并回车',
  'dock.creating': '正在创建页面',
  'dock.createFailed': '页面创建失败',
  'dock.retry': '重试',
...
export const en = {
  ...
  'dock.openExternal': 'Open in default browser',
  ...
  'dock.createFailed': 'Could not create the page',
  'dock.retry': 'Retry',
  ...
  'settings.roster.duplicate': 'That Profile name already exists.',
