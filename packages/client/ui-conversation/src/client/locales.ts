...
export const zh = {
  ...
  'annotation.staleAnchor': '无法在原文中定位这段引用',
  'annotation.pinMode': '标注图片',
  'annotation.pin': '标注点 {index}',
...
export const en = {
  ...
  'annotation.staleAnchor': 'Could not locate this quotation in the original text',
  'annotation.pinMode': 'Annotate image',
  'annotation.pin': 'Pin {index}',
