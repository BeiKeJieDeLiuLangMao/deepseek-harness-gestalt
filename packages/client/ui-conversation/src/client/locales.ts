...
export const zh = {
  ...
  'annotation.add': '添加注释',
  'annotation.copy': '复制',
  'annotation.notePlaceholder': '添加说明（可选）',
  'annotation.save': '保存注释',
  'annotation.delete': '删除注释',
  'annotation.discard': '丢弃注释草稿',
  'annotation.summary.one': '{count} 条注释',
  'annotation.summary.other': '{count} 条注释',
  'annotation.item': '注释 {index}：{quote}',
  'annotation.compiled.heading': '注释 {index}',
  'annotation.compiled.quote': '引用：“{value}”',
  'annotation.compiled.image': '图片“{name}”，位置 {x}%, {y}%',
  'annotation.compiled.note': '批示：{value}',
  'annotation.pinMode': '标注图片',
  'annotation.pinModeExit': '退出标注',
  'annotation.gifRefuse': '动画 GIF 不能放置标注点',
  'annotation.overflow': '组装后的请求超过当前模型上下文容量，草稿已保留。',
  'annotation.staleAnchor': '有注释已无法在原文中定位；它仍保留在草稿中，但不再显示高亮。',
...
export const en = {
  ...
  'annotation.discard': 'Discard annotation draft',
  'annotation.summary.one': '{count} annotation',
  'annotation.summary.other': '{count} annotations',
  'annotation.item': 'Annotation {index}: {quote}',
  'annotation.compiled.heading': 'Annotation {index}',
  'annotation.compiled.quote': 'Quoted text: “{value}”',
  'annotation.compiled.image': 'Image “{name}” at {x}%, {y}%',
  'annotation.compiled.note': 'Note: {value}',
  'annotation.pinMode': 'Annotate image',
  'annotation.pinModeExit': 'Exit annotation',
  'annotation.gifRefuse': 'Animated GIFs cannot receive pins',
  'annotation.overflow': 'The assembled request exceeds the selected model context capacity. The draft is unchanged.',
  'annotation.staleAnchor': 'An annotation no longer locates its original text; it stays in the draft without its highlight.',
