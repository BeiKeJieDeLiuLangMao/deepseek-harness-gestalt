 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-(?:file-reference|session|llm|tools|brand|deque|output-retention|typert-protocol|util-crypto|util-values|util-workspace-path)(?:\/|$)|@deepseek-ai\/dsh-browser-workspace\/client$|@deepseek-ai\/dsh-platform-account\/privacy$|@deepseek-ai\/dsh-project-membership\/(?:remote-url|invite-role)$|@deepseek-ai\/dsh-phone-runtime\/swipe$|@deepseek-ai\/dsh-request-trust(?:\/|$)|@deepseek-ai\/dsh-token-meter\/client$|@deepseek-ai\/dsh-host-open-in-app\/shared$|@deepseek-ai\/dsh-agent-presets\/display$|@deepseek-ai\/dsh-spill-policy\/notice$)/
