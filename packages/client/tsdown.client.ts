 ...
 */
export const INLINE_SAFE = /^(?:@deepseek-ai\/dsh-platform-account\/privacy|@deepseek-ai\/dsh-workspace-reference\/src\/(?:search|contract)\.ts|@deepseek-ai\/dsh-(?:host-apiproxy|session|llm|tools|brand)(?:\/|$))/
