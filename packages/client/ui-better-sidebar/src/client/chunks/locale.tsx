...
import { hongKongTraditionalChinese as zhHK } from '../locales-zh-HK.ts'
import { taiwanTraditionalChinese as zhTW } from '../locales-zh-TW.ts'
import { macaoTraditionalChinese as zhMO } from '../locales-zh-MO.ts'
