...
export const ru: Record<string, string> = {
  ...
  addPluginsTabDesc: 'Страницы боковой панели (вкладки) расширяются плагинами. Плагины регистрируются через службу ctx.sidebarRightTabs; щелчок по «Установить» копирует команду — вставьте её в терминал, где находится профиль DSH, и выполните.',
  addPluginsViewerDesc: 'Просмотрщики файлов расширяются плагинами. Плагины регистрируются через службу ctx.sidebarRightTabs; щелчок по «Установить» копирует команду — вставьте её в терминал, где находится профиль DSH, и выполните.',
