...
export const ja: Record<string, string> = {
  ...
  addPluginsTabDesc: 'サイドバーページ（Tab）はプラグインで拡張可能。プラグインは ctx.sidebarRightTabs サービス経由で登録。「インストール」をクリックしてインストールコマンドをコピー、DSH 環境のターミナルに貼り付けて実行。',
  addPluginsViewerDesc: 'ファイルプレビューアーはプラグインで拡張可能。プラグインは ctx.sidebarRightTabs サービス経由で登録。「インストール」をクリックしてインストールコマンドをコピー、DSH 環境のターミナルに貼り付けて実行。',
