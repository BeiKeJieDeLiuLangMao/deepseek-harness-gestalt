...
export function BrowserView(props: TabComponentProps) {
  const official = props.ctx.get('workbenchBrowser') as
    | { renderTab: (next: TabComponentProps) => ReactNode }
    | undefined
  if (official !== undefined) return official.renderTab(props)
  return <SnapshotIframeBrowser {...props} />
}
