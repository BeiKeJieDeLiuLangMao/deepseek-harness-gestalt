...
export interface WorkbenchOwnerProps {
  readonly rightHostId: string
  readonly bottomHostId: string
  /** Current frame width in px. */
  readonly viewportWidth: number
  readonly viewportHeight: number
  readonly centerWidth: number
  readonly rightPanelWidth: number
  readonly rightbarWidth: number
  readonly canShowRight: boolean
  readonly setRightbarWidth: (width: number) => void
  readonly seedRightbarWidth: (width: number) => void
}
