...
export const zh = {
  ...
  'details.output': '输出',
  'details.running': '运行中…',
  'details.document.restricted': '受限预览 · 脚本与网络请求已禁用',
  'details.document.from': '来自 {name}',
  'copy': '复制',
  'copied': '已复制',
  'footnotes': '脚注',
...
export const en = {
  ...
  'details.document.restricted': 'Restricted preview · scripts and network requests are disabled',
  'details.document.from': 'From {name}',
  'copy': 'Copy',
  'copied': 'Copied',
  'footnotes': 'Footnotes',
