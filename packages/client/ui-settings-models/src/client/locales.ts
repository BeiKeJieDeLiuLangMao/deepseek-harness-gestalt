...
export const en = {
  ...
  modelInputHint: 'Leave unselected to inherit the catalog, then this provider’s default.',
  defaultInput: 'Default accepted input',
  defaultInputHint: 'Used when a model does not set its own accepted input. The adapter default is text only.',
  modalityText: 'Text',
  modalityImage: 'Image',
  modelReasoning: 'Thinking levels',
  modelReasoningHint: 'Leave unselected to inherit the catalog — a custom model then has no thinking levels. Setting any level requires one besides Off.',
  modelReasoningDisabled: 'Stored as non-reasoning (reasoningEfforts: false). Selecting a level replaces that.',
  modelReasoningInvalid: 'Choose at least one thinking level other than Off, or leave every level unselected.',
  effortOff: 'Off',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  modelInput: '接受的输入',
  modelInputHint: '都不选则沿用模型目录，再使用本提供方的默认设置。',
  defaultInput: '默认接受的输入',
  defaultInputHint: '模型未单独设置时使用。适配器默认只接受文本。',
  modalityText: '文本',
  modalityImage: '图片',
  modelReasoning: '思考档位',
  modelReasoningHint: '都不选则沿用模型目录；自定义模型此时没有思考档位。若要设置，除「关闭」外至少再选一档。',
  modelReasoningDisabled: '已存为不思考（reasoningEfforts: false）。点选任一档会覆盖这项设置。',
  modelReasoningInvalid: '请至少再选一个除「关闭」以外的档位，或全部不选。',
  effortOff: '关闭',
  effortMinimal: '最低',
  effortLow: '低',
  effortMedium: '中',
