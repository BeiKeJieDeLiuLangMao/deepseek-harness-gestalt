...
function client(overrides: Partial<ProjectMembershipClientFace> = {}): ProjectMembershipClientFace {
  return {
    ...
    invite: vi.fn(async () => ({ id: 'invitation-1', inviteeName: 'mona', grantedRole: 'admin' })),
    issuedInvitations: vi.fn(async () => [{ invitationId: 'invitation-2', inviteeName: 'mona', grantedRole: 'member' }]),
