...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Collapsed Browser preview; ChatView hides the rail below a 240px gutter.',
    doc: 'Collapsed Browser preview; ChatView hides the rail below a 240px gutter.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    occupants: [
      'client-ui-browser BrowserPreview',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-member-questions MemberQuestionDock id \'member-question\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-subagent SubagentHeaderAction id \'subagent-descendants\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'session-log-export SessionLogDownloadDialog id \'session-log-download-dialog\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    source: 'packages/client/ui-trajectory/src/client/slots.ts:15',
  },
  {
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Shared Ask User presentation over JSON questions and a Host submit callback.',
    doc: 'Shared Ask User presentation over JSON questions and a Host submit\ncallback. The member-question dock declares this child; this package\noccupies it. PendingQuestion stays in this package.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.input.dock\' (client-ui-member-questions), so it exists while that entry is mounted',
    occupants: [
      'client-ui-user-questions QuestionPresentationSlot',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'question.presentation\', () => ctx.slots.register(\n      { name: \'question.presentation\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-user-questions/src/client/contract/slots.ts:26',
  },
  {
    key: 'root',
    kind: 'single',
  ...
  {
    key: 'settings.plugin.web-search.provider',
    kind: 'list',
    scope: 'root',
    summary: 'One search-provider tab inside the Web Search card.',
    doc: 'One search-provider tab inside the Web Search card. Extra plugins register\nhere so the card grows new providers without a second top-level card.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.plugin.item\' (client-ui-settings-plugins), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-plugins WebSearchProviderPanel id \'deepseek\'',
      'client-ui-settings-plugins WebSearchProviderPanel id \'anthropic-messages\'',
      'client-ui-settings-plugins WebSearchProviderPanel id \'kimi\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.plugin.web-search.provider\', () => ctx.slots.register(\n      { name: \'settings.plugin.web-search.provider\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings-plugins/src/client/slot-contract.ts:24',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-im AccountsSection id \'im-accounts\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Desktop window drag chrome above the sidebar content.',
    doc: 'Desktop window drag chrome above the sidebar content.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'workbench\' (client-ui-sidebar-right), so it exists while that entry is mounted',
    occupants: [
      'client-ui-im ConversationTab',
      'client-ui-phone OfficialPhoneBody',
      'client-ui-sidebar-documentpreview TextPreview',
      'client-ui-sidebar-files FilesBody',
      'client-ui-sidebar-right GuideBody',
      'client-ui-workbench OfficialWorkbenchBrowserBody',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'sidebar.right.tab.icon',
    kind: 'keyed',
    scope: 'session',
    summary: 'Custom tab icon, dispatched with the tab definition id.',
    doc: 'Custom tab icon, dispatched with the tab definition id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.tab.icon\', () => ctx.slots.register(\n      { name: \'sidebar.right.tab.icon\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    ownerPropsReferences: [
      ...
      'SidebarRightTabPayload',
      'SidebarRightTabPin',
      'SidebarWorkbenchSurface',
      'TabRecord',
    ],
    standardProps: [
      'useResource: UseResource',
  ...
  {
    key: 'sidebar.right.tab.settings',
    kind: 'keyed',
    scope: 'root',
    summary: 'Custom tab settings body, dispatched with the tab definition id.',
    doc: 'Custom tab settings body, dispatched with the tab definition id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.tab.settings\', () => ctx.slots.register(\n      { name: \'sidebar.right.tab.settings\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sidebar-right/src/client/contract/slots.ts:105',
  },
  {
    key: 'sidebar.right.viewer.icon',
    kind: 'keyed',
    scope: 'session',
    summary: 'Custom viewer icon, dispatched with the viewer definition id.',
    doc: 'Custom viewer icon, dispatched with the viewer definition id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.viewer.icon\', () => ctx.slots.register(\n      { name: \'sidebar.right.viewer.icon\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sidebar-right/src/client/contract/slots.ts:99',
  },
  {
    key: 'sidebar.right.viewer.settings',
    kind: 'keyed',
    scope: 'root',
    summary: 'Custom viewer settings body, dispatched with the viewer definition id.',
    doc: 'Custom viewer settings body, dispatched with the viewer definition id.',
    registerOptions: [
      {
        name: 'key',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.right.viewer.settings\', () => ctx.slots.register(\n      { name: \'sidebar.right.viewer.settings\', key: \'<one key the owner dispatches>\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-sidebar-right/src/client/contract/slots.ts:111',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-tool BuiltinToolview',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'root\' (client-ui-layout), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sidebar-right WorkbenchSeat',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Extra cards inside the workspace settings modal, after repository and collaboration.',
    doc: 'Extra cards inside the workspace settings modal, after repository and\ncollaboration. Feature plugins (IM takeover, IM simulation) register\nlist entries; the modal supplies the Workspace id as owner share.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-im TakeoverSection id \'im-takeover\'',
      'client-ui-im SimulationSection id \'im-simulation\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'workspace.settings.section\', () => ctx.slots.register(\n      { name: \'workspace.settings.section\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
