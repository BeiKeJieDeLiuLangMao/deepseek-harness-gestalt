...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Collapsed Browser preview in the Chat scrollport\'s right gutter.',
    doc: 'Collapsed Browser preview in the Chat scrollport\'s right gutter.\nOccupied by ui-browser; ChatView hides the rail when that gutter is\nnarrower than 240px.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  {
    key: 'conversation.details.document',
    kind: 'single',
    scope: 'session',
    summary: 'Focused-document body that replaces the tool details while a document is selected.',
    doc: 'Focused-document body that replaces the tool details while a document\nis selected. The owner supplies the document identity and optional\ninline body; absence uses the three-way markdown/html/file fallback.',
    registerOptions: [],
    ownerProps: [
