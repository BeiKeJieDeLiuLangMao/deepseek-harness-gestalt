...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-schedule ScheduleListAction id \'schedule-list\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.session.header\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'session-log-export SessionLogDownloadHeaderAction id \'session-log-download-dialog\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models DeepSeekOnboardingDialog id \'configure-models\'',
    ],
    replaceRisk: 'none',
