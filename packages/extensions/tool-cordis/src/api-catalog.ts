...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    description: 'Browser Runtime Service Definition. Providers serialize mutations and reject a stale `expectedRevision`; Consumers can therefore coordinate Agent and human operations without relying on last-writer-wins state.',
    methods: [
      {
      ...
      },
      {
        ...
        description: 'Capture deterministic PNG bytes for the addressed open tab.',
        parameters: [{ name: 'request', description: 'Target and cancellation signal.' }],
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'A Browser Runtime Provider committed a new lifecycle state.',
    description: 'A Browser Runtime Provider committed a new lifecycle state.',
