...
| `androidRuntimeVerifyTimeoutMs` | `180000` | H264 画面探测之前，等待 mobilecli 把已准备的 Android 设备列为在线的上限，单位为毫秒；模拟器冷启动可能超过画面探测预算。 |
