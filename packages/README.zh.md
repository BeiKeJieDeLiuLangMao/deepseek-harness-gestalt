...
| [`browser/`](browser/README.md) | Browser Runtime seam、多个 Provider 与 deferred 工具 | 产品：演进中 API |
...
| [`platform/`](platform/README.md) | Platform 账号身份、Personal Pairing，以及版本化 Relay 与加密 Companion 协议 | 产品：稳定 API |
