...
import type { CreateSessionOptions, EpochHeader, IgnorableEventIntent, PrepareSessionOptions, RequestContext, SessionEvent, SessionEventMap, SessionEventType, SessionHeader, SessionId, SessionSeedEventState, SurfaceIntent, SurfaceEventType } from './types.ts'
...
export class Session {
  ...
  append<T extends SessionEventType>(
    ...
    const intent: SurfaceIntent | IgnorableEventIntent | undefined = opts[0]
    const ignorable = intent !== undefined && 'ignorable' in intent ? intent.ignorable : undefined
    const surfaceMetadata = {
      ...intent !== undefined && 'sourceEventSeqs' in intent
        ? { sourceEventSeqs: intent.sourceEventSeqs } : {},
      ...intent !== undefined && 'surfaceOp' in intent
