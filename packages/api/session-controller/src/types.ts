...
export interface SessionListMetadata {
  /** Whether the folded prefix contains neither a turn nor a received member question. */
...
export type SessionFollowFrame =
  | {
    ...
    /** Exact inherited prefix length at the opening cut, independent of later seed markers. */
