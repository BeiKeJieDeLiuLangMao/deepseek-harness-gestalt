...
declare module '@deepseek-ai/dsh-typert-protocol' {
  ...
  interface TypertRemoteMap {
    'fileReferences/list': (
      ...
      query: string,
      signal?: AbortSignal,
    ) => Promise<RemoteResult<FileReferenceCandidate[]>>
    'session/admitAttachment': (request: SessionAdmitAttachmentRequest) => Promise<RemoteResult<SessionAdmitAttachmentValue>>
    ...
    'session/toolEligibility': (request: SessionToolEligibilityRequest) => Promise<RemoteResult<SessionToolEligibility>>
