...
export class ScheduleService extends TypertRemoteService {
  ...
  /**
   * Install Schedule state and observe only future root Agents.
  ...
  /** Validate a branded wire value at the Host mutation boundary. */
...
/** Install the Schedule owner in this function-plugin fiber. */
