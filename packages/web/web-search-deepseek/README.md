...
| Key | Default | Meaning |
|---|---|---|
| `backend` | `deepseek` | Which settings card the next search reads: `deepseek` or `anthropic-messages`. |
