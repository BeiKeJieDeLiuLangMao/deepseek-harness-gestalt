  ...
  it('rejects an invalid Workspace snapshot before it reaches the log', async () => {
    ...
    const invalid: unknown[] = [
      ...
      { ...VALID, workspaces: [{
        ...
        browsers: [
          { browserId: 'b', tabs: [{ tabId: 't' }], activeTabId: 't' },
          { browserId: 'b', tabs: [{ tabId: 'u' }], activeTabId: 'u' },
        ],
      }] },
      ...
      { ...VALID, workspaces: [{
        ...
        profileId: 'p',
        activeBrowserId: null,
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't' }, { tabId: 't' }], activeTabId: null }],
      }] },
      { ...VALID, workspaces: [{
        workspaceId: 'ws',
        profileId: 'p',
        activeBrowserId: null,
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't' }], activeTabId: 'missing' }],
      }] },
      { ...VALID, workspaces: [{
        workspaceId: 'ws',
        profileId: 'p',
        activeBrowserId: 'missing',
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't' }], activeTabId: 't' }],
      }] },
