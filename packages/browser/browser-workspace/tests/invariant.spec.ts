  ...
  it('rejects an invalid Workspace snapshot before it reaches the log', async () => {
    ...
    const invalid: unknown[] = [
      ...
      { ...VALID, workspaces: [{
        ...
        browsers: [
          { browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: 0 }], activeTabId: 't' },
          { browserId: 'b', tabs: [{ tabId: 'u', controlOwner: 'agent', revision: 0 }], activeTabId: 'u' },
        ],
      }] },
      ...
      { ...VALID, workspaces: [{ workspaceId: 'ws', profileId: 'p', activeBrowserId: null, browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'other', revision: 0 }], activeTabId: null }] }] },
      { ...VALID, workspaces: [{ workspaceId: 'ws', profileId: 'p', activeBrowserId: null, browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent' }], activeTabId: null }] }] },
      { ...VALID, workspaces: [{ workspaceId: 'ws', profileId: 'p', activeBrowserId: null, browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: -1 }], activeTabId: null }] }] },
      { ...VALID, workspaces: [{ workspaceId: 'ws', profileId: 'p', activeBrowserId: null, browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: 1.5 }], activeTabId: null }] }] },
      { ...VALID, workspaces: [{
        workspaceId: 'ws',
        profileId: 'p',
        activeBrowserId: null,
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: 0 }, { tabId: 't', controlOwner: 'agent', revision: 0 }], activeTabId: null }],
      }] },
      { ...VALID, workspaces: [{
        workspaceId: 'ws',
        profileId: 'p',
        activeBrowserId: null,
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: 0 }], activeTabId: 'missing' }],
      }] },
      { ...VALID, workspaces: [{
        workspaceId: 'ws',
        profileId: 'p',
        activeBrowserId: 'missing',
        browsers: [{ browserId: 'b', tabs: [{ tabId: 't', controlOwner: 'agent', revision: 0 }], activeTabId: 't' }],
      }] },
