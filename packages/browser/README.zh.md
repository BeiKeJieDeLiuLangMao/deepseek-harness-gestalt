...
| [`browser-runtime-deterministic/`](browser-runtime-deterministic/README.md) | 确定性的临时、命名持久与共享 Profile Provider | 提供 `ctx.browserRuntime` |
| [`browser-runtime-electron/`](browser-runtime-electron/README.md) | 用于临时、命名持久与共享 Profile 的进程内 Electron Provider | 提供 `ctx.browserRuntime` |
| [`browser-runtime-tandem/`](browser-runtime-tandem/README.md) | 用于临时、命名持久与共享 Profile 的 Tandem 形态 HTTP 协议客户端 | 提供 `ctx.browserRuntime` |
