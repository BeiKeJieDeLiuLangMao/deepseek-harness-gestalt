...
- Human takeover and Dock chrome remain later work. Session-local Workspace ownership lives in [`dsh-browser-workspace`](../browser-workspace/README.md).
