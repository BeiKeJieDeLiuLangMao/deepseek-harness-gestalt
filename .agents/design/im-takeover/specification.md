...
The specification distinguishes two baselines. The **review baseline** is `origin/master`: this pull request branches from it, and the fixed snapshot is not its ancestor. The **implementation baseline** is the dual-parent combined base `d4fd51ceb546b20e7d579bffffb3d4d0f7b3fcca` (combining synchronization staging `4797d94e8d571fa564a6e253d4ad771b036b6de0` and current master `005b49be715eb82826de65a06d1a9686c5577e39`) with verified candidate milestone `0d8d0faa5451bf13960e4d585cb267f0d408a43a`. The predecessor head `54a56df8ca8ed1f2e0493224936bf18cc1505645` is retained solely as frozen design and prototype evidence without rewriting prototype archives. Source interface review (B0) is performed directly within the candidate worktree under authorized implementation.
...
- The delivery starts from the combined baseline `d4fd51ceb5` (ancestors: `4797d94e8d` + `005b49be71`) with verified candidate milestone `0d8d0faa5451bf13960e4d585cb267f0d408a43a`; implementation does not chase moving upstream branches.
- The candidate branch `codex/im-takeover-combined-base` is published to remote as the authoritative implementation anchor. Predecessor `54a56df8ca` provides frozen prototype design evidence.
