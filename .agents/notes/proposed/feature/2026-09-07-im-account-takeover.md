...
- `B0` (Signed off) -> `T1` (IM domain configuration & routing core skeleton)
- `T1` -> `T2` (Message history, cursor tracking, reliable outbound delivery)
  - *Dependency note*: Issue #616 is strictly blocked by Issue #615 to prevent type definition and storage schema write competition.
