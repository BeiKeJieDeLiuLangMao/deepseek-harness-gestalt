...
The product-visible Web GIF for dock, paste ignore, folder descent, and settings is recorded from this ticket's pull-request runtime by the delivery flow before merge and attached to that PR.
