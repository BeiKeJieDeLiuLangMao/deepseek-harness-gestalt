...
Two Sessions can own isolated Workspaces over the same Runtime. Reload reconstructs tab ownership and each tab's last committed revision from the Session log. Named Profiles remain isolated identities.
