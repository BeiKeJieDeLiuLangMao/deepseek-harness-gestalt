...
- Users see reminder output in normal conversation. Host tools list retained paused state; the management board UI is not mounted, and neither dispatch nor a future board overstates model success or acknowledgement.
