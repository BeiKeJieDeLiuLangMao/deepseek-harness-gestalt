...
[Web 客户端子系统](../../../../docs/subsystems/web-client.zh.md)持有逐 Session 的 composer 状态，[Session 子系统](../../../../docs/subsystems/session.zh.md)则将仅追加事件日志定义为实时渲染与历史回放的真源。因此，图片接收、持久化、提供方转换和渲染需要遵循同一个明确的生命周期。
