...
- Desktop shutdown waits for pending and running Web Host processes to exit; the smoke test rejects an orphaned child, missing Desktop composition or updater bridge, and a visible inactive Update Control.
