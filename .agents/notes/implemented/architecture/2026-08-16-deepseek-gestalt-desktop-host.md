...
- The Desktop icon test pins all three source digests and their container signatures, requires a 512x512 RGBA PNG, and checks macOS, Windows, packaged-resource, Dock, and BrowserWindow wiring.
