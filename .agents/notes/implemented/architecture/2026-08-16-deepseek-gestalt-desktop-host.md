...
- macOS expanded and collapsed layouts keep the unchanged sidebar controls and center Session content below native controls; Windows keeps its caption buttons at the right edge of the full-window drag row without shifting Session content.
