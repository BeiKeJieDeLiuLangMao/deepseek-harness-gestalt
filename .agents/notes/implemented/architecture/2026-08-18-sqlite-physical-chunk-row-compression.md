...
The current [Session format](../../../../docs/subsystems/session.md) and [persistence](../../../../docs/subsystems/persistence.md) references define the JSONL format and write scheduling. The original [session-persistence decision](2026-06-14-session-persistence.md) continues to own backend-neutral service semantics.
