...
- 代价：id→ctx 换乘纪律、provide 的 Concurrent 纪律都是约定而非类型强制，靠 review 与测试钉住。单一状态轴仍会在 Session 存在前隐藏 machine face；[常驻 conversation shell](../../../../packages/client/ui-conversation/README.zh.md)会在这段时间把激活操作转到 Workspace picker。
