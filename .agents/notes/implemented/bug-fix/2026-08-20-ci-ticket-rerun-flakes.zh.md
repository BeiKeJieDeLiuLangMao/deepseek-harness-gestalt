...
[2026-08-19-inherited-ci-baseline-reds](2026-08-19-inherited-ci-baseline-reds.md) 的基线修复合并后，所有仍打开的 Mobile Companion 票级 PR 仍然在重叠 CI 车道上失败。其中两处是基线 flake，会挡住每一个走到对应门禁的 PR，而不是票级内容本身。
