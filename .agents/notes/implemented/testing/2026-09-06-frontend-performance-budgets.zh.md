...
[运行 34605338358，job 103282272549](https://github.com/gestaltrun/deepseek-harness-gestalt/actions/runs/34605338358/job/103282272549) 在标准托管 Ubuntu 上记录最慢分页中位数 958.296829 ms，超过此前 875 ms 分页上限。该终点的预期为 1000 ms，按打开把 875.306861 ms 取整到 900 ms 的同一方式向上取整；不变的 1.25× 余量产生 1250 ms 上限。记录中位数对照在 875 ms 拒绝 958.296829 ms，在 1250 ms 接受它，并拒绝超过新上限一毫秒的值。打开与 Trajectory 的托管预期仍为 900 ms 和 500 ms。
