...
[Run 34605338358, job 103282272549](https://github.com/gestaltrun/deepseek-harness-gestalt/actions/runs/34605338358/job/103282272549) on standard hosted Ubuntu records a slowest-page median of 958.296829 ms against the previous 875 ms paging limit. The endpoint-specific expectation is 1000 ms, rounding up that median the same way open rounded 875.306861 ms to 900 ms; unchanged 1.25× headroom gives 1250 ms. The recorded-median control rejects 958.296829 ms at 875 ms, accepts it at 1250 ms, and rejects one millisecond above the new limit. Open and Trajectory hosted expectations remain 900 ms and 500 ms.
