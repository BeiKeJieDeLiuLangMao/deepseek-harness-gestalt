...
- Remote Companion traffic and attachment flows are outside this shell. `CompanionForegroundRuntime` binds visibility to the real Relay lifecycle and `settleCompanionInteraction` requires foreground reconnect plus Desktop-authoritative sync; native APNs/FCM registration and real-device delivery remain outside this shell.
