...
- The encrypted Companion Session transport still has to supply the authoritative `ConversationSnapshot`, image loader, and submit/cancel adapters to the bundled entry; the presentation seam does not synthesize those values or reuse `companion-push` as Session authority.
