...
- **Production Personal Pairing uses Snow HTTP/WSS** — Companion application frames still use the development AES-GCM seal; pairing-key HKDF and IK reconnect remain deferred.
