...
- **Production Desktop pairing ownership is not assembled** — Relay peer discovery exists, but Desktop remains fail-closed until first pairing and durable static state are endpoint-owned and physical-device evidence plus independent review admit the exact Snow provider.
