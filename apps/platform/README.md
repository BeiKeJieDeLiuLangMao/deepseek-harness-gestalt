...
- Redis and PostgreSQL certificate verification cannot be disabled by product configuration. Disposable local-store tests inject explicitly named non-TLS fixtures without importing the listen entry and are not operated acceptance.
