...
const pythonSource = source.split("<<'MEMBERSHIP_PY'\n")[1]?.split('\nMEMBERSHIP_PY')[0]
if (pythonSource === undefined) throw new Error('shipped membership host entry is missing')
const python = pythonSource
